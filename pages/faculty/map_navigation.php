<?php
// CHRONONAV_WEB_DOSS/pages/faculty/map_navigation.php
// Map navigation page for faculty
...
<div class="map-container">
    <div class="map-header">
        <div style="display: flex; align-items: center; gap: 15px;">
            <a href="../../pages/faculty/dashboard.php" class="btn-back" title="Back to Dashboard">
