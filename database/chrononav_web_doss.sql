...
CREATE TABLE rooms (
    ...
    -- Room availability status (Available=1, Unavailable/Renovation=0)
    is_available TINYINT(1) DEFAULT 1,

    -- Map coordinates for positioning on campus map
...
CREATE TABLE faculty_verification_codes (
    -- Unique identifier for the verification code (Primary Key, Auto-Incremented)
    id INT(11) NOT NULL AUTO_INCREMENT,

    -- The verification code (unique, generated by admin)
    verification_code VARCHAR(50) NOT NULL UNIQUE,

    -- Description/name for this code (e.g., which department it's for)
    ...
    -- ID of the user who used this code (if used)
    used_by_user_id INT(11) DEFAULT NULL,

    -- Timestamp when the code was used
    used_at TIMESTAMP NULL DEFAULT NULL,

    -- Expiration date for the verification code
...
-- ADMIN ACCOUNT SETUP
-- ========================================
-- This section creates the initial admin account for the system
-- Admin Name: Vince Andrew Santoya
-- Admin Email: hanssantoya@gmail.com
-- Admin ID: ADMN001
-- Password: vince123456 (hashed with PASSWORD_DEFAULT)
-- Hash: $2y$10$K.N1z9V.L7c0V8a4X9Q9c.p9Z6Y8X7W6V5U4T3S2R1Q0P9O8N7M6

-- Remove all existing admin accounts (if any)
...
INSERT INTO users (
    ...
    'hanssantoya@gmail.com',
    '$2y$10$K.N1z9V.L7c0V8a4X9Q9c.p9Z6Y8X7W6V5U4T3S2R1Q0P9O8N7M6',
    'admin',
    NULL,
    NULL,
    'ADMN001',
